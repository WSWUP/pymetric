#!/usr/bin/env python
#--------------------------------
# Name:         metric_model1.py
# Purpose:      Run METRIC Model 1 for all images
#--------------------------------
...
def arg_parse():
    ...
    parser = argparse.ArgumentParser(
        description='Batch METRIC Model 1',
    ...
    # By default, metric_model1_func will NOT compute raster statistics.
