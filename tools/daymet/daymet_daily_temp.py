#--------------------------------
# Name:         daymet_daily_temp.py
# Purpose:      Extract DAYMET temperature
#--------------------------------
...
def main(start_dt, end_dt, netcdf_ws, ancillary_ws, output_ws,
    ...
    # daymet_band_dict['tmin'] = 'tmin'
    # daymet_band_dict['tmax'] = 'tmax'
...
def arg_parse():
    ...
    parser = argparse.ArgumentParser(
        description='DAYMET daily temperature',
